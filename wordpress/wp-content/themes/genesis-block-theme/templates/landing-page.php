...
<div class="home_top">
  ...
  <div class="home_top_center">
    ...
    <div class="home_top_copy"><?php the_content(); ?></div>
  </div>
</div>

<div class="mission_statement_section">
  <p>
    Under the sea, on top of the sea, or over the sea - we support companies
    building foundational technologies across the maritime domain:
  </p>
...
<div class="section_normal" id="team">
  <div class="section_title">Operating Team</div>
  <div class="team">
    <?php $args = array( 'numberposts' => 5, 'post_type' => 'team', 'order'=>
    'DESC', 'orderby' => 'title' ); $team = get_posts( $args ); foreach ($team
    as $team_member) { ?>
    <div class="team_member">
      <div
        class="team_member_image"
      ...
      <div class="team_member_info">
        ...
        <div class="team_member_linkedin">
          <a href="<?php echo get_field('linkedin_url', $team_member->ID); ?>"
            ><svg
              width="40"
              height="39"
              viewBox="0 0 40 39"
        ...
        <div class="popup">
          ...
          <div class="popup_inner">
            <div class="popup_top">
              ...
              <?php if (get_field('linkedin_url', $team_member->ID)) { ?>
              <div class="popup_linkedin">
                <a
                  href="<?php echo get_field('linkedin_url', $team_member->ID); ?>"
                  ><svg
                    width="40"
                    height="39"
                    viewBox="0 0 40 39"
...
<div class="section_normal" id="advisors">
  ...
  <div class="advisors">
    ...
    $advisors = get_posts( $args ); foreach ($advisors as $advisor) { ?>
        ...
        <div class="popup">
          ...
          <div class="popup_inner">
            <div class="popup_top">
              ...
              <?php if (get_field('linkedin_url', $advisor->ID)) { ?>
              <div class="popup_linkedin">
                <a href="<?php echo get_field('linkedin_url', $advisor->ID); ?>"
                  ><svg
                    width="40"
                    height="39"
                    viewBox="0 0 40 39"
      ...
      slides: [
        {
          ...
          video: {
            src: ["/wp-content/uploads/2022/08/dyne-hero.mp4-720p.mp4"],
            loop: true,
            mute: true,
          },
        },
