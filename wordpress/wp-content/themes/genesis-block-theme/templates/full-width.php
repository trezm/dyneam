...
<!-- <section> -->
	<div class="periodic_table_section" id="about">
		<div class="periodic_table">
			...
			<div class="symbols">
				<div class="symbol">
					<img src="/wp-content/uploads/2022/08/dy.svg"/>
				</div>
				<div class="symbol">
			...
			foreach ($team as $team_member) { ?>
				<div class="team_member">
					...
					<div class="team_member_info">
						...
						<!-- <div class="team_member_bio_excerpt"><?php echo wp_trim_words( $team_member->post_content, 50, '.' ); ?><div class="read_more"  data-popup="<?php echo $team_member->post_name; ?>">READ MORE</div></div> -->
